...
<body>
    ...
    @include('partials.taldar-popup')
        ...
        <!-- Special Offer Popup for Taldar Tech Consultancy -->
                    ...
                    <div class="col-12">
                        <div class="rx-inner-menu-desk">
                            <a href="{{ route('home') }}" class="rx-header-btn">
                                <h1 style="font-weight: 700; font-size: 24px; color: white;">Kevins Bed & Breakfast</h1>
                            </a>
                            ...
                            <div class="rx-main-menu" id="navbarSupportedContent">
                                    <ul class="navbar-nav" style="display: flex; justify-content: center; align-items: center; width: 100%; gap: 12px;">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('restaurants') }}">Nearby Restaurants</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <!-- <div class="header-button">
                                        <a href="https://bookingengine.stayflexi.com/?hotel_id=20862&checkin=10-14-2020&checkout=10-15-2020&num_nights=1&checkinSlot=10&checkinSlot=10&num_guests=1&widget=true" class="rx-btn-one" target="_blank" style="display: flex; align-items: center; justify-content: center; height: 100%;">Book Now</a>
                                    </div> -->
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="rx-menu-inner">
                        <div class="rx-menu-contact">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('restaurants') }}">Nearby Restaurants</a>
                                </li>
                                <li>
                                    <a href="https://www.google.com/maps/@11.6710447,92.7264715,3a,90y,289.86h,88.83t/data=!3m8!1e1!3m6!1sAF1QipMaHOoh0g3_2l6H4lBO5Zurpdpu9sTeFrRf5j7H!2e10!3e11!6shttps:%2F%2Flh5.googleusercontent.com%2Fp%2FAF1QipMaHOoh0g3_2l6H4lBO5Zurpdpu9sTeFrRf5j7H%3Dw114-h120-k-no-pi-0-ya71.64512-ro-0-fo100!7i5376!8i2688?shorturl=1" target="_blank" rel="noopener">Virtual Tour</a>
                                </li>
                                <li>
                                    <a href="{{ route('tour-packages') }}">Special Tour Packages</a>
                                </li>
                                <li>
                    ...
                    <div class="col-lg-2 col-sm-4 col-6 col-420-full mb-24 footer-order-2">
                        <div class="rx-footer-items">
                            ...
                            <div class="rx-items-contact">
                                <ul>
                                    <li>
                                        <a href="{{ route('spa') }}">Spa & Beauty</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('gym') }}">Gym & Fitness</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('rooms') }}">Rooms & Suites</a>
                                    </li>
                                    <li>
                                        <a href="https://bookingengine.stayflexi.com/?hotel_id=20862&checkin=10-14-2020&checkout=10-15-2020&num_nights=1&checkinSlot=10&checkinSlot=10&num_guests=1&widget=true" target="_blank">Book Now</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="rx-footer-inner-contact">
                            <div class="rx-footer-left-side-contact">
                                <p>&copy; 2024 <a href="{{ route('home') }}">Royalx</a>, All Rights Reserved.</p>
                            </div>
