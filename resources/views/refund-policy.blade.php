...
<head>
    ...
    <meta name="description" content="Kevins Bed & Breakfast - Refund & Cancellation Policy">
    <meta name="keywords" content="refund, cancellation, policy, kevins, bed and breakfast, Sri Vijaya Puram, port blair, hotel">
    <title>Refund & Cancellation Policy | Kevins Bed & Breakfast</title>
            ...
            <div class="row mb-minus-24">
                <div class="col-12" data-aos="fade-up" data-aos-duration="1000">
                    <div class="rx-banner text-center rx-banner-effects">
                        ...
                        <h4>Refund & <span> Cancellation Policy</span></h4>
                    </div>
                </div>
                <div class="col-12 mb-24" data-aos="fade-up" data-aos-duration="1000">
                    <div class="rx-about-contact">
                    <p>At <strong>KEVINS Bed & Breakfast</strong>, we aim to offer a seamless booking experience and a memorable stay. Please review our cancellation and refund terms below:</p>
                    </div>
                </div>
                <div class="col-12 mb-24" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <p>Guests may modify their booking once, at least 3 days before check-in, subject to availability:</p>
                    <ul>
                        <li>Changes must be for the same or higher rate.</li>
                        <li>The same room type and booking conditions apply.</li>
                    </ul>

                    <h2>Refund Process</h2>
                    <p>Eligible refunds will be processed within 2 to 3 working days via UPI or bank transfer.</p>
