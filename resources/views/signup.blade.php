...
<!-- Mirrored from maraviyainfotech.com/projects/royalx-html/royalx-html/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Jan 2025 05:47:28 GMT -->
<head>
    <meta charset="UTF-8">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="rx-banner text-center rx-banner-effects">
                                                    <p><img src="assets/img/banner/left-shape.svg" alt="banner-left-shape" class="svg-img left-side">Registration<img src="assets/img/banner/right-shape.svg" alt="banner-right-shape" class="svg-img right-side"></p>
                                            ...
                                            <div class="rx-inline-block direct">
                                                <a href="signin.html" class="direct-to">You have an account?</a>
                                            </div>
                                            <div class="col-12">
                                                <div class="rx-inner-button">
                                                    <a href="index.html" class="back-to"><i class="ri-arrow-left-s-line"></i>Back to Home</a>
