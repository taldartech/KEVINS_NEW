...
<!-- Mirrored from maraviyainfotech.com/projects/royalx-html/royalx-html/restaurant.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Jan 2025 05:47:26 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="rx-inner-menu-desk">
                            ...
                            <div class="rx-main-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('special-tour-packages') }}">Special Tour Packages</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="rx-testimonials-contact">
                                    ...
                                    <div class="inner-contact">
                                        <p>"Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto
                                            at sint eligendi possimus perspiciatis ariores reiciendis hic
