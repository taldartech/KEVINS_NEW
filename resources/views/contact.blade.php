...
<!-- Mirrored from maraviyainfotech.com/projects/royalx-html/royalx-html/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Jan 2025 05:47:16 GMT -->
<head>
    <meta charset="UTF-8">
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item rx-dropdown">
                                        ...
                                        <ul class="rx-dropdown-menu">
                                            <li><a class="dropdown-item" href="{{ route('home') }}">Hotel</a></li>
                                    ...
                                    <li class="nav-item rx-dropdown">
                                        ...
                                        <ul class="rx-dropdown-menu">
                                            <li><a class="dropdown-item" href="{{ route('rooms') }}">Rooms 1</a></li>
                                            <li><a class="dropdown-item" #>Rooms 2</a></li>
                                            <li><a class="dropdown-item" #>Rooms 3</a></li>
                                            <li><a class="dropdown-item" href="{{ route('tour-packages') }}">Rooms details</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item rx-dropdown">
                                        ...
                                        <ul class="rx-dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" #>Spa</a></li>
                ...
                <div class="rx-menu-contact">
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li><a href="{{ route('gallery') }}">Gallery 1</a></li>
                                <li><a #>Gallery 2</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li><a href="{{ route('rooms') }}">Rooms 1</a></li>
                                <li><a #>Rooms 2</a></li>
                                <li><a #>Rooms 3</a></li>
                                <li><a href="{{ route('tour-packages') }}">Rooms details</a></li>
                            </ul>
                        </li>
                        <li>
